...
|---|---|---|---|
| 1,000 | 46KB | 11MB / 0.04秒 | 9MB / 0.05秒 |
| 5,000 | 233KB | 27MB / 0.19秒 | 10MB / 0.22秒 |
| 20,000 | 946KB | 81MB / 0.82秒 | 15MB / 0.88秒 |
| 60,000 | 2.8MB | 228MB / 2.53秒 | 28MB / 2.51秒 |
...
処理時間は両モードでほぼ変わりません。
この計測での差は数パーセントで、実行ごとのばらつきと同程度でした。
